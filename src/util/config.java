...
//     static String MAC_jceDir = "/Library/Java/JavaVirtualMachines/jdk1.8.0_231.jdk/Contents/Home/jre/lib/jce.jar";
    ...
    static String MAC_jreDir = "/usr/lib/jvm/java-1.8.0-openjdk-amd64/jre/lib/rt.jar";
    static String MAC_jceDir = "/usr/lib/jvm/java-1.8.0-openjdk-amd64/jre/lib/jce.jar";
...
//         jar_list.add(BASE + "dialer-grpc-core-target_intermediates.jar");
        ...
        // jar_list.add(BASE + "am_intermediates.jar");
        // jar_list.add(BASE + "android-common_intermediates.jar");
        // jar_list.add(BASE + "android.ext.adservices.com.android.extservices_intermediates.jar");
        // jar_list.add(BASE + "android.hidl.base-V1.0-java_intermediates.jar");
        // jar_list.add(BASE + "android.hidl.manager-V1.0-java_intermediates.jar");
        ...
        // jar_list.add(BASE + "android.test.mock_intermediates.jar");
        // jar_list.add(BASE + "android.test.runner_intermediates.jar");
        // jar_list.add(BASE + "androidx.window.extensions_intermediates.jar");
        // jar_list.add(BASE + "androidx.window.sidecar_intermediates.jar");
        ...
        // jar_list.add(BASE + "dialer-common-m2-target-deps_intermediates.jar");
        // jar_list.add(BASE + "dialer-glide-target-deps_intermediates.jar");
        // jar_list.add(BASE + "error_prone_annotations_intermediates.jar");
        // jar_list.add(BASE + "ext_intermediates.jar");
        // jar_list.add(BASE + "framework-adservices.com.android.adservices_intermediates.jar");
        // jar_list.add(BASE + "framework-appsearch.com.android.appsearch_intermediates.jar");
        // jar_list.add(BASE + "framework-bluetooth.com.android.btservices_intermediates.jar");
        // jar_list.add(BASE + "framework-configinfrastructure.com.android.configinfrastructure_intermediates.jar");
        // jar_list.add(BASE + "framework-connectivity.com.android.tethering_intermediates.jar");
        // jar_list.add(BASE + "framework-connectivity-t.com.android.tethering_intermediates.jar");
        // jar_list.add(BASE + "framework-devicelock.com.android.devicelock_intermediates.jar");
        // jar_list.add(BASE + "framework-graphics_intermediates.jar");
        // jar_list.add(BASE + "framework-healthfitness.com.android.healthfitness_intermediates.jar");
        ...
        // jar_list.add(BASE + "framework-ondevicepersonalization.com.android.ondevicepersonalization_intermediates.jar");
        ...
        // jar_list.add(BASE + "framework-sdksandbox.com.android.adservices_intermediates.jar");
        ...
        // jar_list.add(BASE + "framework-uwb.com.android.uwb_intermediates.jar");
        // jar_list.add(BASE + "framework-virtualization.com.android.virt_intermediates.jar");
        ...
        // jar_list.add(BASE + "org.apache.http.legacy_intermediates.jar");
        // jar_list.add(BASE + "requestsync_intermediates.jar");
        // jar_list.add(BASE + "service-adservices.com.android.adservices_intermediates.jar");
        // jar_list.add(BASE + "service-appsearch.com.android.appsearch_intermediates.jar");
        // jar_list.add(BASE + "service-art.com.android.art_intermediates.jar");
        // jar_list.add(BASE + "service-bluetooth.com.android.btservices_intermediates.jar");
        // jar_list.add(BASE + "service-configinfrastructure.com.android.configinfrastructure_intermediates.jar");
        // jar_list.add(BASE + "service-connectivity.com.android.tethering_intermediates.jar");
        // jar_list.add(BASE + "service-devicelock.com.android.devicelock_intermediates.jar");
        // jar_list.add(BASE + "service-healthfitness.com.android.healthfitness_intermediates.jar");
        // jar_list.add(BASE + "service-media-s.com.android.media_intermediates.jar");
        // jar_list.add(BASE + "service-ondevicepersonalization.com.android.ondevicepersonalization_intermediates.jar");
        // jar_list.add(BASE + "service-permission.com.android.permission_intermediates.jar");
        // jar_list.add(BASE + "service-rkp.com.android.rkpd_intermediates.jar");
        // jar_list.add(BASE + "service-scheduling.com.android.scheduling_intermediates.jar");
        // jar_list.add(BASE + "service-sdksandbox.com.android.adservices_intermediates.jar");
        jar_list.add(BASE + "services_intermediates.jar");
        // jar_list.add(BASE + "service-statsd.com.android.os.statsd_intermediates.jar");
        // jar_list.add(BASE + "service-uwb.com.android.uwb_intermediates.jar");
